...
public class GUI extends JFrame{
	...
	private static ImageIcon backgroundImg = (new ImageResize(new ImageIcon(GUI.class.getResource("/img/StarBackground.gif")), GUI.width, GUI.height)).resize();
	private static ImageIcon planetBackgroundImg = (new ImageResize(new ImageIcon(GUI.class.getResource("/img/planetBackground.gif")), GUI.width, GUI.height)).resize();
	private ImageIcon circleImg = (new ImageIcon(GUI.class.getResource("/img/circle.gif")));
	private JLabel background = new JLabel();
	private JButton exit = GUI.gameButton("X", 36);
	private JButton start = GUI.gameButton("Start", 48);
	private JButton back = GUI.gameButton("Back", 48);
	private JButton newGame = GUI.planetButton(new ImageIcon(GUI.class.getResource("/img/NewGame.gif")));
	private JButton loadGame = GUI.planetButton(new ImageIcon(GUI.class.getResource("/img/LoadGame.gif")));
	private JButton rules = GUI.planetButton(new ImageIcon(GUI.class.getResource("/img/Rules.gif")));
	...
	public GUI(Game game) {
		...
		this.background.setBounds(0, 0, GUI.width, GUI.height);
	...
	private void rules() {
		...
		topPlayers = GUI.gameButton("Top Players", 48);
